...
/**
 * Очищает тему от суффикса-типа тестирования, сохраняя год.
 *
 * Срезает «- Предварительное/Контрольное/Итоговое тестирование» (и всё что
 * идёт после), оставляя год «- YYYY» если он есть. Пример:
