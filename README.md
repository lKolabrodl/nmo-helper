...
1. Скачайте [`nmo-helper-chrome-3.1.5.zip`](https://github.com/lKolabrodl/nmo-helper/releases/download/v3.1.5/nmo-helper-chrome-3.1.5.zip)
...
6. Выберите папку `nmo-helper-chrome-3.1.5`
...
1. Скачайте [`firefox_nmo_helper.xpi`](https://github.com/lKolabrodl/nmo-helper/releases/download/v3.1.5/firefox_nmo_helper.xpi)
