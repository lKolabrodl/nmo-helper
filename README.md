...
3. Найди **Tampermonkey** и нажми **«Сведения»**
</br>
![Режим разработчика](screenshots/info.png)
4. Выберите **«Доступ к сайтам»** - **На всех сайтах**
5. Включи **«Разрешить пользовательские скрипты»** и **«Закрепить на панели инструментов»**
</br>
![Режим разработчика](screenshots/settings.png)
...
![Режим разработчика](screenshots/script-on.png)

## Использование

1. Убедитесь что плагин запущен и скрипт включен
</br>
![Режим разработчика](screenshots/plugin.png)
2. Открой страницу тестирования НМО
3. В правом верхнем углу появится панель **NMO Helper**
4. Выбери источник ответов в выпадающем списке
5. Вставь URL страницы с ответами в поле ввода
6. Нажми **▶ Запуск**
...
| ответ не совпал с вариантами | оранжевый | ответ найден, но не совпадает с вариантами на странице |
