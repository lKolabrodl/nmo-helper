...
4. Выберите источник, откуда вы хотите брать ответы **rosmed** / **24forcare**
5. Нажми **▶ Запуск**

![demo](demo/step_7.gif)

6. Если автопоиск ничего не нашёл, попробуйте сами найти ответы на сайте: `rosmedicinfo.ru` или `24forcare.com`
7. Вставь URL страницы с ответами в поле ввода: **URL страницы с ответами**
8. Нажми **▶ Запуск**
