...
1. Скачай файл `nmo-helper.user.js` из этого репозитория
2. Открой Tampermonkey → **Панель управления** → вкладка **Утилиты**
3. В разделе «Импорт» выбери скачанный файл
4. Нажми **Установить**
...
3. Выбери источник ответов в выпадающем списке
4. Вставь URL страницы с ответами в поле ввода
5. Нажми **▶ Запуск**
