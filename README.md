...
1. Скачайте [`nmo-helper-chrome-3.1.0.zip`](https://github.com/lKolabrodl/nmo-helper/releases/download/v3.1.0/nmo-helper-chrome-3.1.0.zip)
...
6. Выберите папку `nmo-helper-chrome-3.1.0`
